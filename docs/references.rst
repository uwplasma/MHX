...
Core tearing and plasmoid literature:

- Furth, Killeen, Rosenbluth (1963) *Finite-resistivity instabilities of a sheet pinch*.
  Phys. Fluids 6, 459. DOI: https://doi.org/10.1063/1.1706761
- Coppi et al. (1976) *Resistive internal kink modes* (Coppi regime). OSTI report.
  DOI: https://doi.org/10.2172/7268294
- Loureiro et al. (2007) *Instability of current sheets and formation of plasmoid chains*.
  Phys. Rev. Lett. 95, 235003. DOI: https://doi.org/10.1103/PhysRevLett.95.235003
- Samtaney et al. (2009) *Formation of plasmoid chains in magnetic reconnection*.
  Phys. Rev. Lett. 103, 105004. DOI: https://doi.org/10.1103/PhysRevLett.103.105004
- Bhattacharjee et al. (2009) *Fast reconnection in high-Lundquist-number plasmas due to the plasmoid instability*.
  Phys. Plasmas 16, 112102. DOI: https://doi.org/10.1063/1.3264103
- Pucci & Velli (2014) *Reconnection of quasi-singular current sheets: The ideal tearing mode*.
  ApJL 780, L19. DOI: https://doi.org/10.1088/2041-8205/780/2/L19

Reduced MHD and pseudo-spectral foundations:

- Strauss (1976) *Nonlinear, three-dimensional magnetohydrodynamics of noncircular tokamaks*.
  Phys. Fluids 19, 134. DOI: https://doi.org/10.1063/1.861310

Differentiable programming stack:
