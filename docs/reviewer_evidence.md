...
| Rutherford production executor | Restartable reduced-MHD chunks with checkpoint state, histories, resume plans, figures, and hashes. | Execution-path validation; production physics requires completed long runs and convergence. | [production.py](https://github.com/uwplasma/MHX/blob/main/src/mhx/campaigns/production.py), [test_production_campaign.py](https://github.com/uwplasma/MHX/blob/main/tests/test_production_campaign.py) |
