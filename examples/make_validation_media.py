...
def main() -> None:
    ...
    (periodic_double_harris_long_docs_dir / "figures").mkdir(parents=True, exist_ok=True)
    for name in (
        "periodic_double_harris_seeded_long_run.png",
        "periodic_double_harris_flux.gif",
        "periodic_double_harris_current.gif",
    ):
        shutil.copy2(
